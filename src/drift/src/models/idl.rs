...
pub mod types {
    ...
    impl<'de> serde::Deserialize<'de> for Signature {
        fn deserialize<D: serde::Deserializer<'de>>(d: D) -> std::result::Result<Self, D::Error> {
            ...
            s.try_into().map(Signature).map_err(serde::de::Error::custom)
        }
    }
...
pub mod accounts {
    ...
    impl ToAccountMetas for InitializeUser {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                AccountMeta { pubkey: self.user, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.user_stats, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.state, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.authority, is_signer: true, is_writable: false },
                AccountMeta { pubkey: self.payer, is_signer: true, is_writable: true },
    ...
    impl ToAccountMetas for InitializeRfqUser {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                AccountMeta { pubkey: self.rfq_user, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.authority, is_signer: true, is_writable: false },
                AccountMeta { pubkey: self.user, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.payer, is_signer: true, is_writable: true },
                AccountMeta { pubkey: self.rent, is_signer: false, is_writable: false },
    ...
    impl ToAccountMetas for InitializeSwiftUserOrders {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                AccountMeta { pubkey: self.swift_user_orders, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.authority, is_signer: true, is_writable: false },
                AccountMeta { pubkey: self.payer, is_signer: true, is_writable: true },
                AccountMeta { pubkey: self.rent, is_signer: false, is_writable: false },
                AccountMeta { pubkey: self.system_program, is_signer: false, is_writable: false },
    ...
    impl ToAccountMetas for InitializeReferrerName {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                AccountMeta { pubkey: self.referrer_name, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.user, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.user_stats, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.authority, is_signer: true, is_writable: false },
                AccountMeta { pubkey: self.payer, is_signer: true, is_writable: true },
    ...
    impl ToAccountMetas for Deposit {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                AccountMeta { pubkey: self.state, is_signer: false, is_writable: false },
                AccountMeta { pubkey: self.user, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.user_stats, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.authority, is_signer: true, is_writable: false },
                AccountMeta { pubkey: self.spot_market_vault, is_signer: false, is_writable: true },
                AccountMeta {
    ...
    impl ToAccountMetas for Withdraw {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                ...
                AccountMeta { pubkey: self.authority, is_signer: true, is_writable: false },
                AccountMeta { pubkey: self.spot_market_vault, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.drift_signer, is_signer: false, is_writable: false },
                AccountMeta {
                    pubkey: self.user_token_account,
                    is_signer: false,
                    is_writable: true,
    ...
    impl ToAccountMetas for TransferDeposit {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                AccountMeta { pubkey: self.from_user, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.to_user, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.user_stats, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.authority, is_signer: true, is_writable: false },
                AccountMeta { pubkey: self.state, is_signer: false, is_writable: false },
                AccountMeta {
    ...
    impl ToAccountMetas for PlaceAndMakePerpOrder {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                ...
                AccountMeta { pubkey: self.user, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.user_stats, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.taker, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.taker_stats, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.authority, is_signer: true, is_writable: false },
            ]
        }
    }
    ...
    impl ToAccountMetas for PlaceSwiftTakerOrder {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                ...
                AccountMeta { pubkey: self.swift_user_orders, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.authority, is_signer: true, is_writable: false },
                AccountMeta { pubkey: self.ix_sysvar, is_signer: false, is_writable: false },
            ]
        }
    }
    #[automatically_derived]
    ...
    impl ToAccountMetas for BeginSwap {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                ...
                AccountMeta { pubkey: self.out_token_account, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.in_token_account, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.token_program, is_signer: false, is_writable: false },
                AccountMeta { pubkey: self.drift_signer, is_signer: false, is_writable: false },
                AccountMeta { pubkey: self.instructions, is_signer: false, is_writable: false },
            ]
        }
    }
    #[automatically_derived]
    ...
    impl ToAccountMetas for ForceDeleteUser {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                ...
                AccountMeta { pubkey: self.user_stats, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.state, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.authority, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.keeper, is_signer: true, is_writable: true },
                AccountMeta { pubkey: self.drift_signer, is_signer: false, is_writable: false },
            ]
        }
    }
    ...
    impl ToAccountMetas for FillPerpOrder {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                AccountMeta { pubkey: self.state, is_signer: false, is_writable: false },
                AccountMeta { pubkey: self.authority, is_signer: true, is_writable: false },
                AccountMeta { pubkey: self.filler, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.filler_stats, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.user, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.user_stats, is_signer: false, is_writable: true },
            ]
        }
    ...
    impl ToAccountMetas for AdminDisableUpdatePerpBidAskTwap {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                AccountMeta { pubkey: self.admin, is_signer: true, is_writable: false },
                AccountMeta { pubkey: self.state, is_signer: false, is_writable: false },
                AccountMeta { pubkey: self.user_stats, is_signer: false, is_writable: true },
            ]
        }
    ...
    impl ToAccountMetas for SettleExpiredMarket {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                AccountMeta { pubkey: self.admin, is_signer: true, is_writable: false },
                AccountMeta { pubkey: self.state, is_signer: false, is_writable: false },
                AccountMeta { pubkey: self.perp_market, is_signer: false, is_writable: true },
            ]
        }
    }
    #[automatically_derived]
    ...
    impl ToAccountMetas for LiquidatePerp {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                AccountMeta { pubkey: self.state, is_signer: false, is_writable: false },
                AccountMeta { pubkey: self.authority, is_signer: true, is_writable: false },
                AccountMeta { pubkey: self.liquidator, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.liquidator_stats, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.user, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.user_stats, is_signer: false, is_writable: true },
            ]
        }
    ...
    impl ToAccountMetas for SettleRevenueToInsuranceFund {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                AccountMeta { pubkey: self.state, is_signer: false, is_writable: false },
                AccountMeta { pubkey: self.spot_market, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.spot_market_vault, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.drift_signer, is_signer: false, is_writable: false },
                AccountMeta {
                    pubkey: self.insurance_fund_vault,
    ...
    impl ToAccountMetas for UpdateFundingRate {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                AccountMeta { pubkey: self.state, is_signer: false, is_writable: false },
                AccountMeta { pubkey: self.perp_market, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.oracle, is_signer: false, is_writable: false },
            ]
        }
    }
    #[automatically_derived]
    ...
    impl ToAccountMetas for UpdatePrelaunchOracle {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                AccountMeta { pubkey: self.state, is_signer: false, is_writable: false },
                AccountMeta { pubkey: self.perp_market, is_signer: false, is_writable: false },
    ...
    impl ToAccountMetas for UpdatePerpBidAskTwap {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                ...
                AccountMeta { pubkey: self.perp_market, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.oracle, is_signer: false, is_writable: false },
                AccountMeta { pubkey: self.keeper_stats, is_signer: false, is_writable: false },
                AccountMeta { pubkey: self.authority, is_signer: true, is_writable: false },
            ]
        }
    }
    ...
    impl ToAccountMetas for UpdateUserQuoteAssetInsuranceStake {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                ...
                AccountMeta { pubkey: self.user_stats, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.signer, is_signer: true, is_writable: false },
                AccountMeta {
                    pubkey: self.insurance_fund_vault,
                    is_signer: false,
                    is_writable: true,
    ...
    impl ToAccountMetas for InitializeInsuranceFundStake {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                AccountMeta { pubkey: self.spot_market, is_signer: false, is_writable: false },
                AccountMeta {
                    pubkey: self.insurance_fund_stake,
                    is_signer: false,
                    is_writable: true,
    ...
    impl ToAccountMetas for TransferProtocolIfShares {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                AccountMeta { pubkey: self.signer, is_signer: true, is_writable: false },
                AccountMeta { pubkey: self.transfer_config, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.state, is_signer: false, is_writable: false },
                AccountMeta { pubkey: self.spot_market, is_signer: false, is_writable: true },
                AccountMeta {
                    pubkey: self.insurance_fund_stake,
    ...
    impl ToAccountMetas for UpdatePythPullOracle {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                ...
                AccountMeta { pubkey: self.encoded_vaa, is_signer: false, is_writable: false },
                AccountMeta { pubkey: self.price_feed, is_signer: false, is_writable: true },
            ]
        }
    }
    #[automatically_derived]
    ...
    impl ToAccountMetas for PostPythPullOracleUpdateAtomic {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                ...
                AccountMeta { pubkey: self.guardian_set, is_signer: false, is_writable: false },
                AccountMeta { pubkey: self.price_feed, is_signer: false, is_writable: true },
            ]
        }
    }
    ...
    impl ToAccountMetas for PauseSpotMarketDepositWithdraw {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                AccountMeta { pubkey: self.state, is_signer: false, is_writable: false },
                AccountMeta { pubkey: self.keeper, is_signer: true, is_writable: false },
                AccountMeta { pubkey: self.spot_market, is_signer: false, is_writable: true },
                AccountMeta {
                    pubkey: self.spot_market_vault,
                    is_signer: false,
    ...
    impl ToAccountMetas for Initialize {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                AccountMeta { pubkey: self.admin, is_signer: true, is_writable: true },
                AccountMeta { pubkey: self.state, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.quote_asset_mint, is_signer: false, is_writable: false },
                AccountMeta { pubkey: self.drift_signer, is_signer: false, is_writable: false },
                AccountMeta { pubkey: self.rent, is_signer: false, is_writable: false },
                AccountMeta { pubkey: self.system_program, is_signer: false, is_writable: false },
                AccountMeta { pubkey: self.token_program, is_signer: false, is_writable: false },
    ...
    impl ToAccountMetas for InitializeSpotMarket {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                AccountMeta { pubkey: self.spot_market, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.spot_market_mint, is_signer: false, is_writable: false },
                AccountMeta { pubkey: self.spot_market_vault, is_signer: false, is_writable: true },
                AccountMeta {
                    pubkey: self.insurance_fund_vault,
                    is_signer: false,
    ...
    impl ToAccountMetas for InitializeSerumFulfillmentConfig {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                AccountMeta { pubkey: self.base_spot_market, is_signer: false, is_writable: false },
                AccountMeta {
                ...
                AccountMeta { pubkey: self.state, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.serum_program, is_signer: false, is_writable: false },
                AccountMeta { pubkey: self.serum_market, is_signer: false, is_writable: false },
                AccountMeta { pubkey: self.serum_open_orders, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.drift_signer, is_signer: false, is_writable: false },
                AccountMeta {
    ...
    impl ToAccountMetas for InitializePhoenixFulfillmentConfig {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                ...
                AccountMeta { pubkey: self.state, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.phoenix_program, is_signer: false, is_writable: false },
                AccountMeta { pubkey: self.phoenix_market, is_signer: false, is_writable: false },
                AccountMeta { pubkey: self.drift_signer, is_signer: false, is_writable: false },
                AccountMeta {
    ...
    impl ToAccountMetas for UpdateSerumVault {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                AccountMeta { pubkey: self.state, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.admin, is_signer: true, is_writable: true },
                AccountMeta { pubkey: self.srm_vault, is_signer: false, is_writable: false },
            ]
        }
    }
    #[automatically_derived]
    ...
    impl ToAccountMetas for DepositIntoPerpMarketFeePool {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                ...
                AccountMeta { pubkey: self.perp_market, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.admin, is_signer: true, is_writable: false },
                AccountMeta { pubkey: self.source_vault, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.drift_signer, is_signer: false, is_writable: false },
                AccountMeta { pubkey: self.quote_spot_market, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.spot_market_vault, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.token_program, is_signer: false, is_writable: false },
            ]
        }
    ...
    impl ToAccountMetas for InitializePrelaunchOracle {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                AccountMeta { pubkey: self.admin, is_signer: true, is_writable: true },
                AccountMeta { pubkey: self.prelaunch_oracle, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.state, is_signer: false, is_writable: false },
                AccountMeta { pubkey: self.rent, is_signer: false, is_writable: false },
                AccountMeta { pubkey: self.system_program, is_signer: false, is_writable: false },
            ]
    ...
    impl ToAccountMetas for InitializePythLazerOracle {
        fn to_account_metas(&self) -> Vec<AccountMeta> {
            vec![
                AccountMeta { pubkey: self.admin, is_signer: true, is_writable: true },
                AccountMeta { pubkey: self.lazer_oracle, is_signer: false, is_writable: true },
                AccountMeta { pubkey: self.state, is_signer: false, is_writable: false },
                AccountMeta { pubkey: self.rent, is_signer: false, is_writable: false },
                AccountMeta { pubkey: self.system_program, is_signer: false, is_writable: false },
            ]
