...
use crate::kamino::utils::consts::{REFERRER_STATE_SIZE, REFERRER_TOKEN_STATE_SIZE, USER_METADATA_SIZE};
...
#[derive(PartialEq, Derivative, Default, BorshSerialize, BorshDeserialize, Zeroable)]
#[derivative(Debug)]
#[repr(C)]
